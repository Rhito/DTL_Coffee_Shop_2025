...
import { ShoppingCart, LogOut, LogIn, User, ChevronDown, Coffee} from "lucide-react";
    ...
    <div className="relative">
      ...
      {isUserMenuOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-white shadow-xl rounded-lg p-2 z-10">
          <Link className="px-2 py-1 text-gray-600 hover:text-gray-900 flex items-center transition duration-200 hover:bg-blue-100 rounded-lg" to="/profile">
